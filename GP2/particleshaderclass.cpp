...
bool ParticleShaderClass::Initialize(ID3D10Device* device, HWND hwnd)
{
	...
	// Initialize the shader that will be used to render the triangles.
...
void ParticleShaderClass::Render(ID3D10Device* device, int indexCount, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix, D3DXMATRIX projectionMatrix, 
...
void ParticleShaderClass::RenderShader(ID3D10Device* device, int indexCount)
{
